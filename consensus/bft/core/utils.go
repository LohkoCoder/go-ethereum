...
func (c *core) checkMsgFromProposer(src bft.Validator) error {
...
func (c *core) checkPrepareQC(qc *bft.QuorumCert) error {
	if qc == nil {
...
func (c *core) checkPreCommittedQC(qc *bft.QuorumCert) error {
	if qc == nil {
...
func (c *core) checkLockedProposal(msg bft.Proposal) error {
...
func (c *core) verifyCrossEpochQC(qc *bft.QuorumCert) error {
...
func (c *core) checkView(msgCode bft.MsgType, view *bft.View) error {
...
func (c *core) preExecuteBlock(proposal bft.Proposal) error {
...
func proposal2QC(proposal bft.Proposal, round *big.Int) *bft.QuorumCert {
	block := proposal.(*types.Block)
	h := block.Header()
	qc := new(bft.QuorumCert)
	qc.View = &bft.View{
		Height: block.Number(),
		Round:  round,
	}
