...
func (c *core) sendNewView(view *bft.View) {
	logger := c.newLogger()
...
func (c *core) handleNewView(data *bft.Message, src bft.Validator) error {
	logger := c.newLogger()
...
func (c *core) getHighQC() *bft.QuorumCert {
	var maxView *bft.QuorumCert
