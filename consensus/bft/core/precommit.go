...
func (c *core) handlePrepareVote(data *bft.Message, src bft.Validator) error {
	logger := c.newLogger()
...
func (c *core) handlePreCommit(data *bft.Message, src bft.Validator) error {
	logger := c.newLogger()
...
func (c *core) acceptPrepare(prepareQC *bft.QuorumCert, proposal bft.Proposal) {
