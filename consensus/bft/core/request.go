...
func (c *core) handleRequest(req *bft.Request) error {
	logger := c.newLogger()
...
func (s *requestSet) checkRequest(view *bft.View, req *bft.Request) error {
...
func (s *requestSet) StoreRequest(req *bft.Request) {
	s.mtx.Lock()
	defer s.mtx.Unlock()
...
func (s *requestSet) GetRequest(view *bft.View) *bft.Request {
	s.mtx.Lock()
	defer s.mtx.Unlock()
