...
func (c *core) handlePreCommitVote(data *bft.Message, src bft.Validator) error {
	logger := c.newLogger()
...
func (c *core) handleCommit(data *bft.Message, src bft.Validator) error {
	logger := c.newLogger()
...
func (c *core) lockQCAndProposal(qc *bft.QuorumCert) {
